...
def runCudaAssignment():
    ...
    try:
        if exactComparison:
            ...
            results['compareOutput'] = subprocess.check_output(['./compare', 'blended.gold', random_output_name, perPixelErrorTolerance, globalErrorTolerance], stderr = subprocess.STDOUT)
    except subprocess.CalledProcessError, e:
        #images don't match
        #dump image anyway?
